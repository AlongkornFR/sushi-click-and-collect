...
export default function Mentionslegales() {
    ...
    <div className="text-resize">
        <div id="mentions-legales" className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
                    <h1 className="text-4xl font-bold mb-6">Mentions légales :</h1>
                    <h3 className="text-2xl font-semibold mb-4 mt-8">Ce site est édité par&nbsp;:</h3>

                    <p className="mb-4">SU-RICE SARL (Société à responsabilité limitée) {/* au capital de € */} dont le siège social est sis 53 boulevard Carnot   - 06400 Cannes.</p>

                    <p className="mb-6 space-y-1">
                    SIRET : 95196138200011<br />
                    RCS : 	Cannes B 951 961 382<br />
                    {/* Code APE : <br /> */}
                    N° TVA : FR70951961382
                    </p>
                        ...
                        <p className="mb-6 space-y-1">
                    Téléphone&nbsp;: 06 83 97 73 67<br />
                    Adresse  de courrier électronique&nbsp;: <a href="mailto:contact@su-rice.com" title="contact@su-rice.com" className="text-blue-600 hover:underline">contact@su-rice.com</a><br />
                    Directeur de la publication&nbsp;: Alexandre  LICAKIS<br />
                    Responsable du site&nbsp;: Alexandre  LICAKIS
                    </p>

                    <h3 className="text-2xl font-semibold mb-4 mt-8">Ce site est hébergé par&nbsp;:</h3>
                    <p className="mb-6">Regicom Webformance, SAS au capital de 150&nbsp;000 € dont le siège social est sis 36-40 Rue Raspail, 92300, LEVALLOIS PERRET, France.<br />
                    RCS Nanterre n° 525 312 294<br />
                    Code  APE&nbsp;: 7311Z <br />
                    Téléphone&nbsp;: 0 811 69 69 77</p>

                    <h3 className="text-2xl font-semibold mb-4 mt-8">Conditions générales d'utilisation</h3>

                    <h4 className="text-xl font-semibold mb-3 mt-6">Art. 1 Conditions d'utilisation</h4>
                    <p className="mb-4">
                        Toute  personne qui accède au site <a href="http://www.su-rice.com" title="www.su-rice.com" target="_blank" className="text-blue-600 hover:underline">www.su-rice.com</a> (ci-après le «&nbsp;Site&nbsp;») s'engage à respecter les  présentes conditions générales d'utilisation, qui pourront pour certains  services être complétées par des conditions particulières.
                    </p>
                    <p className="mb-6">
                        SU-RICE se réserve  le droit de modifier et de mettre à jour à tout moment l'accès au Site ainsi que les présentes conditions d'utilisation. Ces modifications et mises à jour s'imposent à  l'utilisateur qui doit en conséquence se référer régulièrement à cette rubrique  pour vérifier les Conditions Générales en vigueur.
                    </p>

                    <h4 className="text-xl font-semibold mb-3 mt-6">Art. 2 Données personnelles et autres données </h4>
                    <p className="mb-4">
                        2.1
                        Les données sont exclusivement destinées à SU-RICE, à ses filiales ou aux membres de  son réseau commercial à des fins d'enquêtes, d'analyses, de communications  institutionnelles, d'opérations relatives à la gestion clients ou, si vous en  êtes d'accord, de propositions commerciales.
                        Ces informations sont confidentielles  et conservées par SU-RICE, ses filiales et les membres de son réseau commercial.
                        Conformément à la loi « Informatique et Libertés » du 06/01/78, vous disposez d'un  droit d'accès, de rectification et de suppression de ces données ainsi que d'un  droit de vous opposer à ce que ces données fassent l'objet d'un traitement en  nous contactant par courrier à l'adresse suivante : 53 boulevard Carnot   - 06400 Cannes ou par e-mail à  l'adresse <a href="mailto:contact@su-rice.com" title="contact@su-rice.com" className="text-blue-600 hover:underline">contact@su-rice.com</a>.
                    </p>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        Dans  l'hypothèse où vous avez accepté dans nos formulaires de recevoir par email des  informations et sollicitations commerciales émanant de notre société et de son  réseau de magasins à l'enseigne de SU-RICE, vous aurez à tout moment la faculté de revenir  sur cette décision, soit en cliquant sur le lien prévu à cet effet en bas des  mails que vous recevez, soit en envoyant un mail avec pour objet  «&nbsp;désabonnement&nbsp;» à l'adresse suivante&nbsp;: <a href="mailto:contact@su-rice.com" title="contact@su-rice.com" className="text-blue-600 hover:underline">contact@su-rice.com</a>.
                    </p>
                    <p className="mb-6">
                        2.2
                    ...
                    <h4 className="text-xl font-semibold mb-3 mt-6">Art. 3 Liens hypertextes</h4>
                    <p className="mb-6">
                        Si  vous souhaitez mettre en place un lien hypertexte vers notre Site, vous devez  en conséquence prendre contact avec le Responsable du Site. SU-RICE ne peut en  aucun cas être tenue pour responsable du contenu des sites qui font l'objet  d'un lien hypertexte à partir du présent Site.
                    </p>
                    ...
                    <p className="mb-4">
                        ...
                        (ci-après «&nbsp;Google&nbsp;»).
                        Google Analytics  utilise des&nbsp;cookies<em>&nbsp;</em> pour aider SU-RICE et l'hébergeur à analyser l'utilisation du Site par ses utilisateurs.
                        ...
                        Google utilisera  cette information dans le but d'évaluer votre utilisation du Site, de compiler  des rapports sur l'activité du Site à destination de SU-RICE et de l'hébergeur et de  fournir d'autres services relatifs à l'activité du site et à l'utilisation d'Internet.
                        Google est susceptible de communiquer ces données à des tiers en cas  d'obligation légale ou lorsque ces tiers traitent ces données pour le compte de  Google, y compris notamment SU-RICE, l'éditeur du&nbsp; Site et  à l'hébergeur.
                    ...
                    <h5 className="text-lg font-semibold mb-3">Pour Firefox à partir de la version 12 :</h5>
                    <ol className="list-decimal list-inside mb-6 space-y-2 ml-4">
                        <li>Dans la barre de  menu, choisir le menu <strong>outils;</strong></li>
                    ...
                    <h5 className="text-lg font-semibold mb-3">Pour Opéra à partir de la version 11&nbsp;:</h5>
                    <ol className="list-decimal list-inside mb-6 space-y-2 ml-4">
                    ...
                    <h5 className="text-lg font-semibold mb-3">Pour Google Chrome&nbsp;:</h5>
                    <ol className="list-decimal list-inside mb-6 space-y-2 ml-4">
                    ...
                    <h4 className="text-xl font-semibold mb-3 mt-6">Art. 5 Contenu du Site</h4>
                    <p className="mb-4">
                        SU-RICE, l'hébergeur  et, plus généralement, toute société contribuant à la conception, à la  réalisation et à la mise en ligne de ce Site s'efforcent d'assurer l'exactitude  et la mise à jour régulière des informations diffusées sur ce Site.
                        SU-RICE et les prestataires  précités se réservent le droit de corriger et modifier à tout moment le contenu  du Site sans que leur responsabilité puisse être engagée de ce fait, SU-RICE pouvant  apporter à tout moment des améliorations et/ou changements au(x) produit(s)  décrits sur ce Site.
                    </p>
                        <p className="mb-6">
                            ...
                            Par ailleurs, ces prix  maximum conseillés sont susceptibles d'évoluer périodiquement ou à l'occasion de  l'évolution des collections de SU-RICE.
                        </p>

                    <h4 className="text-xl font-semibold mb-3 mt-6">Art. 6 Contenu manifestement illicite</h4>
                    <p className="mb-4">
                        Conformément à la loi du 21 juin 2004 pour la  confiance dans l'économie, vous pouvez alerter l'hébergeur de la présence d'un  contenu que vous considérez comme illicite en remplissant le <a href="https://cdnnen.proxi.tools/assets/Core/pdf/formulaire-de-denonciation.pdf" target="_blank" className="text-blue-600 hover:underline">formulaire téléchargeable</a> (cliquez&nbsp;sur  le lien).
                    ...
                    <h4 className="text-xl font-semibold mb-3 mt-6">Art.  7 Droit applicable</h4>
                    <p>
